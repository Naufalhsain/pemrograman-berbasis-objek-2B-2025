...
public class Mahasiswa1 {
   ...
   // Constructor
public Mahasiswa1(String nama, String nim, String prodi, String alamat){
    this.nama = nama;
    this.nim = nim;
    this.prodi = prodi;
    this.alamat = alamat;
...
// Mahasiswa ke 1
    ...
    Mahasiswa1 mahasiswa1 = new Mahasiswa1(nama1, nim1, prodi1, alamat1);
...
// Mahasiswa ke 2
    ...
    Mahasiswa1 mahasiswa2 = new Mahasiswa1(nama2, nim2, prodi2, alamat2);
...
// Mahasiswa ke 3
    ...
    Mahasiswa1 mahasiswa3 = new Mahasiswa1(nama3, nim3, prodi3, alamat3);
